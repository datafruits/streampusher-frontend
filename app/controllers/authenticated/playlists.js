...
export default class PlaylistsController extends Controller.extend(PlaylistQueryParams.Mixin) {
  @service router;
  @tracked tracksQuery;
  ...
  get playlistsSearchParams() {
    return { playlistsQuery: this.playlistsQuery, playlistsPage: this.playlistsPage };
  }
